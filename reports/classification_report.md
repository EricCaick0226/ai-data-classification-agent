...
| patient | diagnosis_result | text | 患者诊断结果 | 基础资源 / 服务范围与对象 / 患者 / 患者敏感信息 | 4级 | 一般数据4级 | 有条件共享 | 不予开放 | diagnosis_result 直接表征患者疾病诊断结论，属于病历核心内容，具有高度隐私性和敏感性，符合‘患者敏感信息’定义中‘诊断结果’的明确列举。 | 0.98 | False |
...
| medical_settlement | insurance_amount | decimal | 医保结算金额 | 主题资源 / 其他数据库 / 互联网+医疗健康 / 互联网+医疗保障结算服务 | 3级 | 一般数据3级 | 有条件共享 | 有条件开放 | 字段名为insurance_amount，描述为'医保结算金额'，直接对应互联网+医疗保障结算服务中的核心结算数值，语义与该分类路径完全一致。 | 0.95 | False |
