...
| patient | diagnosis_result | text | 患者诊断结果 | 基础资源 / 服务范围与对象 / 患者 / 患者敏感信息 | 4级 | 一般数据4级 | 有条件共享 | 不予开放 | diagnosis_result 直接表征患者健康状况的核心医疗判断，属于病历核心内容，具有高度隐私性和敏感性，符合‘患者敏感信息’定义中‘诊断结果’的明确示例。 | 0.98 | False |
